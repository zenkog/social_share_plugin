package com.cygnati.social_share_package;
 ...
 * SocialSharePackage
 */
public class SocialSharePackage
    ...
    public SocialSharePackage() {
        this.callbackManager = CallbackManager.Factory.create();
    }

    @Override
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        this.channel = new MethodChannel(binding.getBinaryMessenger(), "social_share_package");
    ...
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "social_share_package");
        final SocialSharePackage plugin = new SocialSharePackage();
